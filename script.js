...
const bancoPreguntas = [
    [ // Fase 1: Grupos
       { q:"¿En qué país se celebró el Mundial de 2014?", a:"Brasil", options:["Brasil","Sudáfrica","Alemania"], hintText:"Allí ocurrió el famoso 7-1 en semifinales.", exp:"El Mundial 2014 se jugó en Brasil, donde Alemania derrotó 7-1 a Brasil en semifinales.", link:"https://www.milenio.com/deportes/futbol-internacional/a-8-anos-brasil-1-7-alemania-copa-del-mundo-de-2014" },

{ q:"¿Qué jugador es conocido como “La Pulga”?", a:"Lionel Messi", options:["Neymar","Lionel Messi","Luka Modrić"], hintText:"Ganó el Mundial en 2022.", exp:"Lionel Messi, capitán de Argentina, es apodado “La Pulga” y ganó el Mundial en 2022.", link:"https://www.milenio.com/deportes/futbol-internacional/lio-o-leo-cual-es-el-verdadero-apodo-de-messi" },

{ q:"¿Qué jugador marcó el famoso “Gol del Siglo” en 1986?", a:"Diego Maradona", options:["Pelé","Diego Maradona","Ronaldo Nazário"], hintText:"También anotó “La Mano de Dios” en ese partido.", exp:"Maradona marcó el “Gol del Siglo” ante Inglaterra en el Mundial de México 1986.", link:"https://www.milenio.com/deportes/futbol-internacional/diego-armando-maradona-36-anos-mano-dios-gol-siglo" },
...
{ q:"¿Contra qué selección anotó Andrés Escobar el autogol que marcó a Colombia en 1994?", a:"Estados Unidos", options:["Estados Unidos","Rumania","Suiza"], hintText:"Fue el país anfitrión en 1994.", exp:"Escobar anotó un autogol ante Estados Unidos, en un partido clave para la eliminación de Colombia.", link:"https://www.milenio.com/futbol-internacional/mundial/andres-escobar-asesinato-mundial-1994" },

{ q:"¿Contra qué selección Luis Suárez evitó un gol con la mano en Sudáfrica 2010?", a:"Ghana", options:["Ghana","Nigeria","Camerún"], hintText:"Fue en cuartos de final y el rival era una selección africana.", exp:"Suárez evitó con la mano un gol de Ghana en el último minuto del tiempo extra.", link:"https://www.milenio.com/futbol-internacional/mundial/uruguay-vs-ghana-2010-mano-suarez-mundial-sudafrica" },

{ q:"¿Qué jugador falló el penal cobrado por la mano de Luis Suárez en 2010?", a:"Asamoah Gyan", options:["Sulley Muntari","Kevin-Prince Boateng","Asamoah Gyan"], hintText:"Jugaba en el Stade Rennais de Francia", exp:"Asamoah Gyan se convirtió en villano al fallar un penal de último minuto contra Uruguay", link:"https://www.milenio.com/futbol-internacional/mundial/uruguay-vs-ghana-2010-mano-suarez-mundial-sudafrica" },

{ q:"¿Qué selección campeona defensora quedó eliminada en fase de grupos en la edición de 2010?", a:"Italia", options:["Italia","Brasil","Alemania"], hintText:"Había ganado el torneo de 2006.", exp:"Italia llegó como campeona defensora, pero quedó fuera en fase de grupos en Sudáfrica.", link:"https://www.milenio.com/futbol-internacional/mundial/la-maldicion-del-campeon-del-mundo-en-los-mundiales" },

{ q:"¿Qué selección campeona del mundo fue eliminada en fase de grupos en 2018?", a:"Alemania", options:["España","Alemania","Francia"], hintText:"Es uno de los máximos ganadores del torneo", exp:"Alemania, campeona en 2014, quedó eliminada en fase de grupos en Rusia.", link:"https://www.milenio.com/futbol-internacional/mundial/la-maldicion-del-campeon-del-mundo-en-los-mundiales" },
...
{ q:"¿Qué selección usó una camiseta con diseño de mezclilla en la edición de 1994?", a:"Estados Unidos", options:["Estados Unidos","Irlanda","Bulgaria"], hintText:"Fue uno de los uniformes más recordados por su estilo extraño.", exp:"Estados Unidos usó una camiseta con efecto de mezclilla en la edición de 1994.", link:"https://www.milenio.com/futbol-internacional/mundial/las-camisetas-mas-feas-en-la-historia-de-los-mundiales-de-futbol" }
  ...
  { "q": "¿Qué selección dejó fuera a Alemania en fase de grupos de Rusia 2018?", "a": "Corea del Sur", "options": ["Japón", "México", "Corea del Sur"], "hintText": "Fue una victoria histórica en el último minuto.", "exp": "Corea del Sur venció 2-0 a Alemania, eliminando al campeón defensor.", "link": "https://www.milenio.com/deportes/rusia-2018/corea-derrota-alemania-echa-manita-mexico" },
  ...
  { q:"¿Qué jugador ganó el Balón de Oro del máximo torneo de selecciones del 2018?", a:"Luka Modrić", options:["Kylian Mbappé","Luka Modrić","Antoine Griezmann"], hintText:"Fue clave en el subcampeonato de su selección.", exp:"Modrić fue el mejor jugador del torneo en Rusia 2018.", link:"https://www.milenio.com/deportes/futbol-internacional/luka-modric-gana-balon-oro-termina-dominio-messi-cristiano" },
  ...
  { "q": "¿Cuántos goles de penal marcó Messi en Qatar 2022?", "a": "4", "options": ["5", "2", "4"], "hintText": "Fueron clave para conseguir el título ese año", "exp": "Messi anotó cuatro penales durante los partidos de Qatar 2022 y falló uno ante Polonia.", "link": "https://www.milenio.com/futbol-internacional/mundial/mejores-finales-copa-mundo-historia-futbol" },
  { "q": "¿Qué partido de México 1986 tuvo “La Mano de Dios”?", "a": "Argentina vs Inglaterra", "options": ["Argentina vs Inglaterra", "Argentina vs Bélgica", "Argentina vs Uruguay"], "hintText": "Maradona anotó dos goles históricos ese día", "exp": "En Argentina vs Inglaterra, Maradona anotó con la mano y después marcó el llamado “Gol del Siglo”.", "link": "https://www.milenio.com/futbol-internacional/mundial/argentina-vs-inglaterra-1986-mundial-mexico" },
  { q:"¿Qué selección recibió reconocimiento internacional por limpiar su vestidor tras partidos en el torneo de 2018?", a:"Japón", options:["Japón","Corea del Sur","Australia"], hintText:"También dejó una nota de agradecimiento en ruso.", exp:"Japón fue reconocido por dejar limpio su vestidor tras su eliminación en Rusia 2018.", link:"https://www.milenio.com/videos/futbol-internacional/mundial/5-momentos-fair-play-mundial-devolvieron-respeto-futbol" },
 { q:"¿Qué selección ha ganado más veces la máxima competencia de selecciones?", a:"Brasil", options:["Brasil","Alemania","Italia"], hintText:"Es la única que ha participado en todas las ediciones del torneo.", exp:"Brasil es la selección más ganadora de la historia, con cinco títulos.", link:"https://www.milenio.com/futbol-internacional/mundial/campeones-copa-mundo-1930-qatar-2022" },
  ...
  { q:"¿Qué selección europea está entre las que más veces han participado y más títulos ha ganado?", a:"Alemania", options:["Alemania","España","Francia"], hintText:"Es famosa por su disciplina y eficiencia.", exp:"Alemania es una de las selecciones con más participaciones y ha sido campeona cuatro veces.", link:"https://www.milenio.com/futbol-internacional/mundial/campeones-copa-mundo-1930-qatar-2022" }
],
    [ // Fase 3: Cuartos
  ...
  { "q": "¿Qué le dijo Joachim Löw a sus jugadores al medio tiempo entre Brasil y Alemania en 2014?", "a": "Prohibido burlarse del rival", "options": ["El partido está ganado", "Vamos por otros 5", "Prohibido burlarse del rival"], "hintText": "Fue revelado por Sami Khedira en 2022", "exp": "Löw los amenazó con sacarlos del campo si se burlaban del rival.", "link": "https://www.milenio.com/deportes/futbol-internacional/la-amenaza-joachim-low-brasil-1-7-alemania" },
  { "q": "¿Cuántos goles anotó Miroslav Klose en la máxima competencia de selecciones?", "a": "16", "options": ["16", "14", "18"], "hintText": "Es un gol más que Ronaldo Nazário.", "exp": "Klose anotó 16 goles entre las ediciones de 2002 y 2014.", "link": "https://www.milenio.com/futbol-internacional/mundial/top-10-maximos-goleadores-historia-copa-mundo" },
  { "q": "¿Qué selección es la más goleadora en la historia del máximo torneo?", "a": "Brasil", "options": ["Brasil", "Alemania", "Argentina"], "hintText": "También es la única que ha jugado todas las ediciones.", "exp": "Brasil lidera el ranking histórico de goles anotados.", "link": "https://www.milenio.com/futbol-internacional/mundial/top-10-selecciones-goles-historia-mundiales" },
  { "q": "¿Qué dos selecciones superan los 200 goles en la historia de los Mundiales?", "a": "Brasil y Alemania", "options": ["Brasil y Alemania", "Argentina y Francia", "Italia y Argentina"], "hintText": "Son dos potencias históricas del futbol.", "exp": "Brasil y Alemania son las únicas selecciones que han superado los 200 goles.", "link": "https://www.milenio.com/futbol-internacional/mundial/top-10-selecciones-goles-historia-mundiales" },
  { "q": "¿Cuál fue la mascota de México en 1986?", "a": "Pique", "options": ["Chilín", "Naranjito", "Pique"], "hintText": "Buscaba representar la identidad y folklore mexicano", "exp": "Pique fue la mascota oficial de México en 1986.", "link": "https://www.milenio.com/futbol-internacional/mundial/todas-las-mascotas-de-los-mundiales-de-futbol-desde-1966-hasta-2026" }
],
    [ // Fase 4: Semis
  ...
  { "q": "¿Qué rival dejó a México fuera en Corea-Japón 2002?", "a": "Estados Unidos", "options": ["Estados Unidos", "Argentina", "Alemania"], "hintText": "Una de las derrotas más dolorosas para el Tri.", "exp": "Estados Unidos eliminó a México en octavos de final (2-0).", "link": "https://www.milenio.com/futbol-internacional/mundial/mexico-en-los-mundiales-asi-fueron-todas-sus-eliminaciones-historicas" },
  { "q": "¿Quién anotó la famosa volea que eliminó a México en Alemania 2006?", "a": "Maxi Rodríguez", "options": ["Maxi Rodríguez", "Lionel Messi", "Carlos Tevez"], "hintText": "Fue un golazo de Argentina en tiempo extra.", "exp": "Maxi Rodríguez marcó una volea histórica en octavos de final.", "link": "https://www.milenio.com/futbol-internacional/mundial/mexico-en-los-mundiales-asi-fueron-todas-sus-eliminaciones-historicas" },
  { "q": "¿Qué error marcó la eliminación de México ante Argentina en 2010?", "a": "Error de Osorio", "options": ["Error de Osorio", "Expulsión de Rafa Marquez", "Falla de Chicharito"], "hintText": "Significó el segundo gol de Argentina.", "exp": "El gol de Tévez en fuera de lugar y el error de Osorio rompieron el partido.", "link": "https://www.milenio.com/futbol-internacional/mundial/mexico-en-los-mundiales-asi-fueron-todas-sus-eliminaciones-historicas" },
  { "q": "¿Qué frase quedó marcada para México tras la edición de 2014?", "a": "No era penal", "options": ["No era penal", "Sí se pudo", "Jugamos como nunca…"], "hintText": "Hasta hoy se sigue recordando.", "exp": "La polémica jugada de Robben dejó como recuerdo la frase 'No era penal'.", "link": "https://www.milenio.com/futbol-internacional/mundial/mexico-en-los-mundiales-asi-fueron-todas-sus-eliminaciones-historicas" },
  { "q": "¿Contra qué selección cayó México en octavos de final en Rusia 2018?", "a": "Brasil", "options": ["Brasil", "Alemania", "Suecia"], "hintText": "Mismo rival con el que México empató en 2014.", "exp": "Brasil eliminó a México en octavos de final en 2018.", "link": "https://www.milenio.com/futbol-internacional/mundial/mexico-en-los-mundiales-asi-fueron-todas-sus-eliminaciones-historicas" }
],
